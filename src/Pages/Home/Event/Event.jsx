    ...
    return (
        <div className="flex lg:flex-row flex-col gap-10 px-10 my-20">
            <div className="lg:w-[60%]">
                <h2 className="text-6xl text-[#ccc1bd] font-light leading-[70px]">Events & <br /> Activities</h2>
                <p className="text-[#797776] mt-10 pl-20">
            ...
            <div className="lg:w-[40%]">
                ...
                <div className="border border-black p-20  space-y-5">
