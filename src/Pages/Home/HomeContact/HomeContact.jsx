const HomeContact = () => {
    return (
        <div className="flex flex-col lg:flex-row my-20 gap-20 px-5">
            <div className="lg:w-1/2 lg:pl-40 space-y-5">
                <h2 className=" font-light text-sm"> CONTACT US</h2>
                <h3 className="lg:text-4xl text-2xl lg:leading-[45px]">If You Wish to Learn More <br /> About Our Services, <br /> Please Reach Out to Us.</h3>
                <p className="">
            ...
            <div className="lg:w-1/2 lg:px-10">
                ...
                <form
                    ...
                    className="border border-black lg:py-20 py-10 px-10  rounded-md  space-y-7">
