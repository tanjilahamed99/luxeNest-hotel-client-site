...
const NewsLatter = () => {
    ...
    const onSubmit = (data) => {
        ...
        axios.post('https://luxe-next-server.vercel.app/newLatter', newsLatterData)
            .then(res => {
    ...
    return (
        <div className="hero bg-fixed min-h-screen my-20" style={{ backgroundImage: 'url(https://i.ibb.co/qBR9Jw2/main-qimg-781bf9a766d8823133c1b5cd1d70abbe-lq.jpg)' }}>
            ...
            <div className="hero-content text-center w-full">
                <div className="w-1/2">
                    <h1 className="mb-10 text-5xl font-bold text-white">Any Feedback</h1>
                    <form onSubmit={handleSubmit(onSubmit)} className="grid grid-cols-2 items-center gap-10">
                        ...
                        <button type="submit" className="btn col-span-2 btn-outline text-white">Submit</button>
                    </form>
                </div>
            </div>
        </div>
