    ...
    <div className=" my-10 lg:my-20 mb-40 w-full px-5 overflow-hidden">
      <div className=" relative lg:w-[700px] md:w-[500px] mx-auto">
        <img
          ...
          src="https://i.ibb.co/920Fd46/japanese-japan-restaurant-culture.jpg"
          alt=""
        />
        <div
          data-aos="fade-left"
        ...
        >
          ...
          <div className=" w-[300px] lg:w-[480px] space-y-3 md:h-[270px]  lg:h-[430px] py-10 lg:py-32 px-10  h-[190px]">
            <h2 className="text-sm md:mb-4 font-bold">RESTAURANTS</h2>
            <p className="lg:text-3xl md:text-2xl font-light lg:leading-10 text-sm">
              {" "}
              Tailor-Made Activities <br /> for Every Single <br /> Guest at
              Hotel LuxeNext.
            </p>
            <Link to={"/about"}>
