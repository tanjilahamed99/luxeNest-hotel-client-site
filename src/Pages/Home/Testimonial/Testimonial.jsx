...
const Testimonial = () => {
    return (
        <div className="container mx-auto my-20">
            ...
            <p className="font-medium text-center mx-96 text-[#616161]">A wonderful serenity has taken possession of my entire soul, like these royella dolor consectetur adipiscing elit dos eiusmod tempor incididunt resort sweet spring</p>
