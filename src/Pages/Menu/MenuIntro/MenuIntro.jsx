    ...
    return (
        <div className="lg:w-[70%] w-full px-2 mx-auto my-10 md:my-20">
            ...
            <div className="flex flex-col md:flex-row justify-between md:gap-20 gap-5 lg:mt-20 md:mt-10 mt-2 text-lg">
                ...
                <p>
                    Immerse yourself in a world of culinary delight as you explore our diverse menus, ranging from gourmet breakfasts to sumptuous dinners. Whether you crave international cuisines, local specialties, or innovative fusion creations, LuxeNext is Foods Menus page is your passport to an unparalleled dining experience.
                </p>
            </div>
        </div>
    );
